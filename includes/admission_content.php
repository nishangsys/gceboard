				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Admission Officer Dashboard</li>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<?php
									if(isset($_GET['start_reg'])){
										include '../Admission/chose_campus.php';
									}
									if(isset($_GET['create_student'])){
										include '../Admission/create_student.php';
									}
									
									 if (isset($_GET['step_one'])) {
                            include '../Admission/Apply/step_one.php';
                        }
                        if (isset($_GET['confirm_dtype'])) {
                            include '../Admission/Apply/confirm_dtype.php';
                        }
                        if (isset($_GET['start_app'])) {
                            include '../Admission/Apply/start_app.php';
                        }
                        if (isset($_GET['stage_two'])) {
                            include '../Admission/Apply/stage_two.php';
                        }
                        if (isset($_GET['stage_three'])) {
                            include '../Admission/Apply/stage_three.php';
                        }
                        if (isset($_GET['stage_four'])) {
                            include '../Admission/Apply/stage_four.php';
                        }
                        if (isset($_GET['stage_five'])) {
                            include '../Admission/Apply/stage_five.php';
                        }
                        if (isset($_GET['print_form'])) {
                            include '../Admission/Apply/all_applied.php';
                        }

						if (isset($_GET['change_campus'])) {
                            include '../Admission/Apply/all_applicants.php';
                        }
						if (isset($_GET['changing_campus'])) {
                            include '../Admission/Apply/changing_campus.php';
                        }

						if (isset($_GET['update_bio'])) {
                            include '../Admission/Apply/update_bio.php';
                        }
						if (isset($_GET['continue'])) {
                            include '../Admission/Apply/all_started.php';
                        }
						if (isset($_GET['admit_applicant'])) {
                            include '../Admission/Apply/all_applicant.php';
                        }
						...
						if (isset($_GET['admission'])) {
                            include '../Admission/Apply/admission.php';
                        }

						if (isset($_GET['distant_applicant'])) {
                            include '../Admission/Apply/distant_applicant.php';
                        }
						if (isset($_GET['distant'])) {
                            include '../Admission/Apply/distant_admission.php';
                        }


						if(isset($_GET['by_program'])){
							include '../SuperAdmin/Reports/by_program.php';
						}
						
						if(isset($_GET['prog_app'])){
							include '../SuperAdmin/Reports/prog_app.php';
						}
						...
						if(isset($_GET['uncompleted_distant_applicant'])){
							include '../Admission/Apply/uncompleted_distant_applicant.php';
						}
						...
						if (isset($_GET['change_prog'])) {
                            include '../Admission/Apply/change_prog.php';
                        }
						
						if (isset($_GET['changing_prog'])) {
                            include '../Admission/Apply/changing_prog.php';
                        }
						if (isset($_GET['changing_progsave'])) {
                            include '../Admission/Apply/changing_progsave.php';
                        }
