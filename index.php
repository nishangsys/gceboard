						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="blue" id="id-text2"> CONTROL PORTAL</span>
								</h1>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
														 <label for="inputEmail4">Username or Telephone Number: </label>
															<input type="text" name="usr_email" class="form-control" placeholder="Username" />
													...
													<div class="clearfix">
														...
														<button type="submit" name="doLogin" class="width-35 pull-right btn btn-sm btn-primary">
